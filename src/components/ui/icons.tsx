...
export function DeviceArrowIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
export function DeviceCardsIcon(props: React.SVGProps<SVGSVGElement>) {
  let id = useId()
...
export function DeviceClockIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 32 32" aria-hidden="true" {...props}>
      <circle cx={16} cy={16} r={16} fill="#A3A3A3" fillOpacity={0.2} />
      <path
...
export function DeviceListIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
export function DeviceLockIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 32 32" aria-hidden="true" {...props}>
      <circle cx={16} cy={16} r={16} fill="#A3A3A3" fillOpacity={0.2} />
      <path
...
export function DeviceChartIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 32 32" fill="none" aria-hidden="true" {...props}>
      <path
        fillRule="evenodd"
