...
export default function ListingPreview({ listing, share = true, target }: ListingCardProps) {
  ...
  return (
    <div
      className="relative mb-3 grid grid-cols-1 overflow-hidden rounded-lg md:grid-cols-[1fr_auto]"
    ...
    >
      ...
      <div className="flex grow flex-col items-stretch justify-center p-3">
