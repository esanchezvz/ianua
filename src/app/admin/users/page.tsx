...
const navigation = [
  { name: 'Usuarios', href: '/admin/listings', icon: MagnifyingGlassCircleIcon, current: true },
  { name: 'Propiedades', href: '/admin/listings', icon: Bars4Icon, current: false },
]
const tabs = [
          ...
          <div className="relative z-0 flex flex-1 overflow-hidden">
                    ...
                    {Object.keys(profile.fields).map((field) => (
                      <div key={field} className="sm:col-span-1">
                        ...
                        <dd className="mt-1 text-sm text-gray-900">
                          {profile.fields[field as Field] as string}
                        </dd>
                      </div>
                    ))}
            ...
            <aside className="hidden w-96 shrink-0 border-r border-gray-200 xl:order-first xl:flex xl:flex-col">
              <div className="px-6 pb-4 pt-6">
                ...
                <p className="mt-1 text-sm text-gray-600">Buscar en 3,018 usuarios</p>
                ...
                {Object.keys(directory).map((letter) => (
                  <div key={letter} className="relative">
                    ...
                    <ul role="list" className="relative z-0 divide-y divide-gray-200">
                      {directory[letter as keyof typeof directory].map((person: any) => (
                        <li key={person.id}>
